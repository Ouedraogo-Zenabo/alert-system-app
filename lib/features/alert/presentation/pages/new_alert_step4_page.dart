...
class _NewAlertStep4PageState extends State<NewAlertStep4Page> {
  ...
  bool _isFormValid() {
    return nomCtrl.text.isNotEmpty &&
        prenomCtrl.text.isNotEmpty &&
        telCtrl.text.isNotEmpty &&
        fonction != null &&
        structureCtrl.text.isNotEmpty &&
        langue != null;
  }
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Text("Informations du rapporteur",
              ...
              DropdownButtonFormField<String>(
                ...
                validator: (v) =>
                    v == null ? "Veuillez choisir une fonction" : null,
              ),
              ...
              TextFormField(
                ...
                decoration:
                    _inputDecoration("Nom de la structure", Icons.apartment),
                validator: (v) =>
                    v == null || v.isEmpty ? "Champ obligatoire" : null,
              ),
              ...
              DropdownButtonFormField<String>(
                value: langue,
                decoration:
                    _inputDecoration("Langue préférée", Icons.language),
                items: ["Français", "Mooré", "Dioula", "Fulfuldé"]
                    .map((l) => DropdownMenuItem(value: l, child: Text(l)))
                    .toList(),
                onChanged: (v) => setState(() => langue = v),
                validator: (v) =>
                    v == null ? "Veuillez choisir une langue" : null,
              ),
